export const portfolioProjects = [
  {
    id: "invoice-reconciliation-accounting-firm",
  ...
  {
    id: "one-click-ai-carousel-generator",
  ...
  },
  {
    ...
    metrics: "Lead response time: 36h to 4s - 28% lift in qualified meetings",
    toolsUsed: ["Clearbit", "HubSpot", "Webhooks", "Postgres"],
  },
  {
    id: "hr-tech-onboarding-automation",
